...
use crate::clients::{DownloadResult, TorrentClient};
...
impl Flood {
    pub async fn new(username: String, password: String, url: String, dest: String) -> Self {
...
mod test{
    ...
    async fn test_get_dl_list() {
        let mut client = Flood::new("".to_string(), "".to_string(), "http://10.11.12.130:3000".to_string(), "".to_string()).await;
