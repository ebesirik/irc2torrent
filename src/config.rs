    ...
    impl Config {
        ...
        fn get_irc_default_config() -> irc::client::data::config::Config {
            return irc::client::data::config::Config {
                ...
                alt_nicks: vec![
                    "irc2torrent_".to_string(),
                    "irc2torrent__".to_string(),
                    "irc2torrent___".to_string(),
                    "irc2torrent____".to_string(),
                    "irc2torrent_____".to_string(),
                    "irc2torrent______".to_string(),
                ],
        ...
        pub async fn add_dl_regex(&mut self, regex: String) {
            self.option_data
                ...
                .push(regex);
            let _ = self
                .update_option_file(OPTIONS_CONFIG_FILE.to_string(), &self.option_data)
                .await;
        }
